...
<a
	href="/day{submission.day}"
	class="group relative flex h-full cursor-pointer flex-col gap-4 rounded-lg bg-[#fc7373] bg-opacity-60 p-4 pt-8 transition hover:bg-opacity-100"
>
	<img
